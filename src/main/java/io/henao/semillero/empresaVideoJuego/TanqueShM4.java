...
public class TanqueShM4 extends Vehiculo implements LanzarAtaque{
    public TanqueShM4(int numeroMunicion, int cantidadArmamento, int capacidadPersona, double capacidadTransporteKg, boolean noMunicion, String nombreArmamento) {
